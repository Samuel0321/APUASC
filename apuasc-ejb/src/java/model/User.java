...
public class User implements Serializable {
    ...
    public User(Integer id, String name, String password, String gender, Boolean is_malaysian, String origin_country, Integer phone_number, String IC_number_passportnumber, String email, String home_address, Integer role, Boolean Have_Manager_access) {
        this.id = id;
        this.name = name;
